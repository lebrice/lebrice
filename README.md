...
My job is to **help make AI researchers more productive** and to **optimize experiment code to use compute resources more efficiently**. I do this in several ways:

- I build software tools and libraries that help with different aspects of the research workflow. For example: [a Research Project Template](www.github.com/mila-iqia/ResearchTemplate), [simpleparsing](www.github.com/lebrice/simpleparsing), [milatools](www.github.com/mila-iqia/milatools), [Sequoia](www.github.com/lebrice/Sequoia), [torch-jax-interop](www.github.com/lebrice/torch_jax_interop), [tensor_regression](www.github.com/lebrice/tensor_regression), and many more.
  - [milatools](www.github.com/mila-iqia/milatools) is actively used by over 250 researchers at Mila!
- I prepare and present interactive tutorials to teach good research and software engineering practices to researchers. For example, I give tutorials on writing GPU-friendly training scripts, [debugging distributed training jobs](https://docs.google.com/presentation/d/1q4JkrkztXYK0nc7fkFGWGQcu4dY17HaCoj8Zk2QTcYc/edit?usp=sharing), how to do [profiling of GPU jobs and how to interpret profiler traces](https://docs.google.com/presentation/d/1q4JkrkztXYK0nc7fkFGWGQcu4dY17HaCoj8Zk2QTcYc/edit?usp=sharing), how to write clean code, how to do proper testing, etc.
- I created and hold the IDT Office Hours at Mila, where researchers walk in with their laptop, and I help them sort out their issues and optimize or scale up their ML code. This has led me to meet a significant portion of the 1000+ researchers here at Mila, and to get to help on a very wide range of ML workflows.

As for my own research, my interests revolve around Continual Learning, Self-Supervised Learning, and **Reinforcement Learning**.
Practically, I'm also quite experienced in large-scale distributed training, as well as massively parallel RL training in Jax.
Here are some interesting things I've done:
